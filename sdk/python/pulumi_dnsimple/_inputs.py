...
class RegisteredDomainRegistrantChangeArgsDict(TypedDict):
    ...
    """
    contact_id: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    extended_attributes: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    ...
    (Number) - The ID of the domain registration.
    """
    irt_lock_lifted_by: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Date when the registrant change lock was lifted for the domain
    """
    registry_owner_change: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class RegisteredDomainRegistrantChangeArgs:
    def __init__(__self__, *,
                 ...
                 id: pulumi.Input[Optional[_builtins.int]] = None,
                 irt_lock_lifted_by: pulumi.Input[Optional[_builtins.str]] = None,
                 registry_owner_change: pulumi.Input[Optional[_builtins.bool]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def irt_lock_lifted_by(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Date when the registrant change lock was lifted for the domain
        """
    ...
    def irt_lock_lifted_by(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "irt_lock_lifted_by", value)

    @_builtins.property
    @pulumi.getter(name="registryOwnerChange")
    def registry_owner_change(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        True if the registrant change will result in a registry owner change
        """
    ...
    def registry_owner_change(self, value: pulumi.Input[Optional[_builtins.bool]]):
