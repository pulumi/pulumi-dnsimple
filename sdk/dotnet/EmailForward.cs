...
namespace Pulumi.DNSimple
{
    ...
    public partial class EmailForward : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class EmailForwardArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name part (the part before the @) of the source email address on the domain
        /// </summary>
    ...
    public sealed class EmailForwardState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name part (the part before the @) of the source email address on the domain
        /// </summary>
